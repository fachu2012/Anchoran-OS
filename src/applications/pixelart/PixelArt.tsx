...
export function PixelArtApp() {
  ...
  async function saveToFiles() {
    ...
    const result = await saveGeneratedFile("picture", `Pixel Art ${new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}.png`, dataUrl);
    pushNotification("Pixel Art", "error" in result ? result.error : "Saved to Pictures.");
  }
