    ...
    <div className="app-root">
      ...
      <div className="app-content" style={{ padding: 20, overflowY: "auto" }}>
        ...
        >
          ...
          <br />
          <br />
          Updated through v3.8.6. Left out of the ranking: versions that never got a stable release of their own to
          install and stay on — v2.9.9, v3.3.6, v3.5.0, v3.5.1, v3.5.2, v3.5.3, v3.5.4, v3.5.5, v3.5.6, v3.8.0, v3.8.1, v3.8.2, v3.8.3, v3.8.4 and v3.8.5 (each
          ...
          on forever in the sense the question above asks. v3.8.6 is listed for reference but is still I.P.U.-only
